...
-- ----------------------------
BEGIN;
INSERT INTO `admin_permission` VALUES ('1', '系统权限', '管理后台设置,管理员设置.', '1', '1', '2015-08-22 21:18:08', '2012-03-26 11:00:55'), ('2', '文章权限', '文章,分类,附件设置.', '1', '1', '2015-08-22 21:18:28', '2012-03-26 11:01:03');
COMMIT;
...
CREATE TABLE `article` (
  ...
  `author` varchar(100) NOT NULL DEFAULT '' COMMENT '作者名称',
...
-- ----------------------------
BEGIN;
INSERT INTO `article_category` VALUES ('1', '默认分类', '0', '', '0', '0', '2014-08-14 12:04:06', '2012-05-28 13:24:20');
COMMIT;
